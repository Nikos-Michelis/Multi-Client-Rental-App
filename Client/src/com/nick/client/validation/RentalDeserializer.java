...
import com.nick.client.domain.Car;
import com.nick.client.domain.Member;
import com.nick.client.domain.Room;
                ...
                if(roomData != null) {
                    ...
                    if (roomData.containsKey("Member")) {
                        ...
                        if (memberObject instanceof LinkedTreeMap) {
                            ...
                            Member member = new Member(name, surName, email, phone, password, driverLicense, role);
                    ...
                    System.out.println("Contain field Member " + carData.containsKey("Member"));
                    if (carData.containsKey("Member") || carData.containsKey("member")) {
                        Object memberObject;
                        if(carData.containsKey("member")){
                            memberObject = carData.get("member");
                        }else{
                            memberObject = carData.get("Member");
                        }
                        if (memberObject instanceof LinkedTreeMap) {
